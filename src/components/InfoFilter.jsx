  ...
  return (
    <div>
      <div className="flex md:flex md:text-left justify-start items-center text-zinc-500 py-4">
        <div className="text-base md:text-sm md:block basis-1/4 md:pl-16">
          {user.item}
        </div>
        <div className="text-base md:text-sm md:block basis-1/4 md:pl-16">
          {user.category}
        </div>
        <div className="text-xl md:text-sm md:block basis-1/4 md:pl-16">
          {user.payBy}
        </div>
        <div className="flex">
          <div className="text-xl md:text-base md:block py-0 md:py-0 basis-1/4 md:pl-20">
            {user.price}
          </div>
