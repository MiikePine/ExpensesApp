...
{props.AddNew && (
      ...
      {props.suprimer && (
        <button onClick={props.open} className="px-12 py-4 m-2 items-center  font-bold flex text-center text-sm bg-blue-200 text-zinc-500 rounded-md shadow-lg bg-red hover:bg-zinc-500 hover:text-blue-200">
          {props.suprimer}
