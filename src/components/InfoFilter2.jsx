...
<div className="flex justify-between gap-44 text-zinc-500">
            ...
            <div className="text-base md:text-sm md:block py-2 md:py-0 basis-1/4">{item.category} </div>
            <div className="text-xl md:text-sm md:block py-8 md:py-0 basis-1/4 ">{item.payBy}</div>
            <div className="flex  md:text-base md:block py-4 md:py-0 basis-1/4">
                <div className="text-xl md:text-base md:block py-2 md:py-0 basis-1/4 "> {item.price} </div>
